...
function saveConsole() {
    localStorage.setItem("feature_lookup_2022_console", currConsole);
}
...
let previousStoredConsole = localStorage.getItem("feature_lookup_2022_console");
if (previousStoredConsole == null || previousStoredConsole == "") {
    consoleClear(save = true);
    consolePrintDefault()
} else {
    consoleClear(save = false);
    consolePrint(localStorage.getItem("feature_lookup_2022_console"), hasNewline = false)
}
